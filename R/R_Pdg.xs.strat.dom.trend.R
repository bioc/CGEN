...
Pdg.xs.strat.trend <- function(alpha, betas, xi, Z0,Z1,Z2,n,nStrata, strDat,g.model) {
            ...
            if (g.model=="general"|g.model=="trend") ret[, 3] <- 2*temp.xi            # d0g2.col
            ...
            if (g.model=="general"|g.model=="trend") ret[, 6] <- alpha + (Z2 %*% betas) + 2*temp.xi         #d1g2.col
